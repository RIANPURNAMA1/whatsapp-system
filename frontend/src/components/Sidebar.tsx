          ...
          {canManageMarketing && (
            <div className="pt-2 border-t border-gray-200 space-y-1">
              <button
                ...
                className={`
                  w-full flex items-center justify-between px-3 py-2 rounded-xl transition-all
                  ${isActive(["dashboard", "keyword-management", "link-rotator", "ai-setting"]) 
                    ? "bg-blue-50 text-blue-700" 
                    : "hover:bg-gray-100 text-gray-700"
                  }
                `}
              >
                <div className="flex items-center gap-3">
                  <BarChart2 className={`w-5 h-5 ${isActive(["dashboard", "keyword-management", "link-rotator", "ai-setting"]) ? "text-blue-600" : "text-gray-400"}`} />
