  ...
  return (
    <div className="bg-white rounded-lg border border-[#E4E6EB] flex flex-col overflow-hidden min-h-[650px]">
      ...
      <div className="p-4 border-b border-[#E4E6EB] bg-[#F0F2F5] flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 bg-[#E7F3FF] border border-[#1877F2] rounded-lg">
          <Sparkles className="w-3.5 h-3.5 text-[#1877F2]" />
          <span className="text-[10px] font-bold text-[#1877F2] tracking-wider uppercase">RAG Engine Active</span>
        </div>
      </div>

      <div className="p-6 flex-grow flex flex-col">
        
        <div className="mb-6 p-4 bg-[#F0F2F5] border-l-4 border-[#1877F2] rounded-r-lg">
          <div className="flex gap-3">
            <Info className="w-5 h-5 shrink-0 text-[#1877F2]" />
            <div>
        ...
        {mode === 'text' && (
          <div className="flex-grow flex flex-col">
            <textarea 
              ...
              className="w-full flex-grow bg-[#F0F2F5] border border-[#CCD0D5] rounded-lg px-6 py-6 focus:outline-none focus:border-[#1877F2] focus:ring-1 focus:ring-[#1877F2] font-mono text-sm leading-relaxed text-[#050505] resize-none"
        ...
        {mode === 'pdf' && (
          <div className="flex-grow flex flex-col">
            <div 
              ...
              className="group border-2 border-dashed border-[#E4E6EB] rounded-lg p-10 flex flex-col items-center justify-center hover:border-[#1877F2] hover:bg-[#E7F3FF] transition-all cursor-pointer"
            >
              ...
              <div className="w-14 h-14 bg-[#F0F2F5] rounded-lg flex items-center justify-center mb-4">
                <FileUp className="w-7 h-7 text-[#1877F2]" />
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-white border border-[#CCD0D5] rounded-lg py-2 pl-10 pr-4 text-xs text-[#050505] focus:border-[#1877F2] focus:ring-1 focus:ring-[#1877F2] outline-none"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <input 
                    ...
                    ref={mediaInputRef}
                    accept="image/*"
                    className="w-full text-xs text-[#65676B] file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-[10px] file:font-bold file:bg-[#1877F2] file:text-white hover:file:bg-[#166FE5]"
                  />
                </div>
              </div>
              <button 
                ...
                disabled={!assetName}
                className="w-full bg-[#1877F2] hover:bg-[#166FE5] disabled:opacity-50 text-white py-2.5 rounded-lg text-xs font-bold flex items-center justify-center gap-2 transition-all"
              >
            ...
            <div className="flex-grow overflow-hidden flex flex-col">
              ...
              <div className="grid grid-cols-1 gap-3 overflow-y-auto max-h-[350px] pr-2">
                {mediaAssets.map((item) => (
                  <div key={item.id} className="bg-[#F0F2F5] border border-[#E4E6EB] rounded-lg p-3 flex flex-col md:flex-row gap-4 group hover:border-[#1877F2] transition-colors">
                    ...
                    <div className="flex-grow min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] bg-[#E7F3FF] text-[#1877F2] px-1.5 py-0.5 rounded font-bold">ID: {item.id}</span>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-2 text-[10px] text-[#1877F2]">
                           <Zap size={10} />
