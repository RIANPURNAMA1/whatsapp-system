  ...
  return (
    <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6 mb-8">
      ...
      <button 
        ...
        className="bg-[#0866FF] hover:bg-[#166FE5] disabled:opacity-50 px-6 py-2.5 rounded-lg font-bold flex gap-2 text-white items-center justify-center transition-all text-sm"
      >
